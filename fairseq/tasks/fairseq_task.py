...
class FairseqTask(object):
    ...
    def get_cond_fn_by_srcfile(self, src):
        ...
        rarity_t = open(pre_folder + 'de-rarity.txt', 'r').readlines()
        rarity = {}
        for l in rarity_t:
            word, pos = l.split()
            vocab_idx = self.src_dict.indices[word]
            rarity[vocab_idx] = float(pos)
        # set special token
        rarity[2] = 1.
        rarity[3] = 1.
        #
        ...
        def get_cdf_by_sent(words):
            ...
            for word in words:
                ...
                if word in rarity:
                    ...
                    print("out of vocab rarity data", word)
            score = -score
            # print("s:", score)
