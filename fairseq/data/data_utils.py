...
# def parse_rarity(fast_tune="data-bin/"):
#     # vocab = open(fast_tune + "dict.de.txt", 'r').readlines()
#     # fast_tune += "de-rarity.txt"
#     # rarity_t = open(fast_tune, 'r').readlines()
#     # rarity = {}
#     # for l in rarity_t:
#     #     word, pos = l.split()
...
#     #     vocab_t.append(rarity.get(v, 0.))
#     fast_tune += "train.de.cdf_score"
#     cdf_scores = open(fast_tune, 'r').readlines()
#     cdf_scores = [float(x) for x in cdf_scores]
#     return cdf_scores
#
#
# cdf_scores = parse_rarity()
#
#
...
def batch_by_size(
    ...
    required_batch_size_multiple=1, rarity_cond=None
):
    """
    ...
    try:
        from fairseq.data.data_utils_fast import batch_by_size_fast_cond
