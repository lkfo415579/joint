...
class JointAttentionModel(FairseqModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            '--kernel-size-list',
            type=lambda x: options.eval_str_list(
                x,
                int),
...
@register_model_architecture(
    'joint_attention',
    'local_joint_attention_iwslt_de_en')
def local_joint_attention_iwslt_de_en(args):
    args.kernel_size_list = getattr(
        args, 'kernel_size_list', [
...
@register_model_architecture(
    'joint_attention',
    'local_joint_attention_wmt_en_de_big')
...
@register_model_architecture(
    'joint_attention',
    'local_joint_attention_wmt_en_fr_big')
